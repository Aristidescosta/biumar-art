...
export const BaseLayoutFooter: React.FC = () => {
  return (
    <Flex flexDir={'column'} p={4} className="shadow-2xl">
      <SimpleGrid columns={[2, 4]} spacing={'10px'} as={'footer'}>
        ...
        <Flex display={['none', 'none', 'flex']} mt={2} flex={2} flexDir={'column'}>
      ...
      <Flex display={['flex', 'flex', 'none']} mt={2} flex={2} flexDir={'column'}>
        <Text fontSize={'3xl'} fontWeight={'bold'} className="dark:text-slate-500 mb-2">
          Inscreva-se para receber a nossa newsletter
        </Text>
        <Flex flexDir={'column'} gap={4}>
